...
class UnitTests(unittest.TestCase):
    def test_can_init_with_list(self):
        ...
        self.assertEqual(coefficients, p.coefficients.tolist())
    ...
    def test_can_init_with_ndarray(self):
        coefficients = np.array([1, 2, 4])
        p = Polynomial(coefficients)
        self.assertEqual(coefficients.tolist(), p.coefficients.tolist())
    ...
    def test_can_add_polynomial(self):
        p1 = Polynomial([2, 2, 4])
        p2 = Polynomial([-1, -2, -4])
        self.assertEqual((p1 + p2).coefficients.tolist(), [1, 0, 0])

    def test_can_add_polynomial_different_size(self):
        p1 = Polynomial([1, 2, 4])
        p2 = Polynomial([-1, -2, -4, 5])
        self.assertEqual((p1 + p2).coefficients.tolist(), [-1, -1, -2, 9])

    def test_can_add_number_left(self):
        p1 = Polynomial([1, 2, 4])
        number = -1
        self.assertEqual((p1 + number).coefficients.tolist(), [1, 2, 3])

    def test_can_add_number_right(self):
        p1 = Polynomial([1, 2, 4])
        number = -1
        self.assertEqual((number + p1).coefficients.tolist(), [1, 2, 3])
    ...
    def test_can_add_number_to_zero_polynomial_right(self):
        p1 = Polynomial([])
        number = -1
        self.assertEqual((number + p1).coefficients.tolist(), [-1])

    def test_can_inverse_coefficients(self):
        p1 = Polynomial([1, 2, 4])
        p2 = -p1
        self.assertEqual(p2.coefficients.tolist(), [-1, -2, -4])
    ...
    def test_can_sub_polynomial_different_size(self):
        p1 = Polynomial([1, 2, 4])
        p2 = Polynomial([1, 2, 4, 5])
        self.assertEqual((p1 - p2).coefficients.tolist(), [-1, -1, -2, -1])
    ...
    def test_can_mul_number_left(self):
        p1 = Polynomial([1, 2, 4])
        number = -1
        self.assertEqual((p1 * number).coefficients.tolist(), [-1, -2, -4])

    def test_can_mul_number_right(self):
        p1 = Polynomial([1, 2, 4])
        number = -1
        self.assertEqual((number * p1).coefficients.tolist(), [-1, -2, -4])

    def test_can_kill_polynomial_by_number_mul(self):
        p1 = Polynomial([1, 2, 4])
        number = 0
        self.assertEqual((number * p1).coefficients.tolist(), [0])
    ...
    def test_can_delete_zeros(self):
        self.assertEqual(delete_first_zeros(np.array([0, 0, 1, 2, 0, 3])).tolist(), [1, 2, 0, 3])

    def test_can_kill_list(self):
        self.assertEqual(delete_first_zeros(np.array([0, 0, 0, 0])).tolist(), [0])
